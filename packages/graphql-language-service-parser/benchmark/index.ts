...
const runSplitTest = (name: string, schema: string) => {
  ...
  printResult(result, name, schema);
};
...
const githubGraphqlJsSchema = fs.readFileSync(path.resolve(__dirname, './fixtures/github-graphqljs.graphql'), {
  encoding: 'utf8',
});
...
runGraphqlParserTest('github:graphqljs', githubGraphqlJsSchema);
